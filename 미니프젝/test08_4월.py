...
def insert_april_attendance():
    ...
    try:
        ...
        # 출석 데이터 생성 (2025년 4월 1일 ~ 4월 30일, 월~금만)
        attendance_data = []
        ...
        print(f"ATD 테이블에 {len(attendance_data)}개 출석 데이터 삽입 완료 (4월 한 달간, 월~금만 기록)")
